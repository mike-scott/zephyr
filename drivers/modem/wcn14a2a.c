...
static const struct mdm_control_pinconfig pinconfig[] = {
	/* MDM_BOOT_MODE_SEL */
	PINCONFIG(CONFIG_WCN14A2A_GPIO_MDM_BOOT_MODE_SEL_NAME,
		  CONFIG_WCN14A2A_GPIO_MDM_BOOT_MODE_SEL_PIN),

	/* MDM_POWER */
	PINCONFIG(CONFIG_WCN14A2A_GPIO_MDM_POWER_NAME,
		  CONFIG_WCN14A2A_GPIO_MDM_POWER_PIN),

	/* MDM_KEEP_AWAKE */
	PINCONFIG(CONFIG_WCN14A2A_GPIO_MDM_KEEP_AWAKE_NAME,
		  CONFIG_WCN14A2A_GPIO_MDM_KEEP_AWAKE_PIN),

	/* MDM_RESET */
	PINCONFIG(CONFIG_WCN14A2A_GPIO_MDM_RESET_NAME,
		  CONFIG_WCN14A2A_GPIO_MDM_RESET_PIN),

	/* SHLD_3V3_1V8_SIG_TRANS_ENA */
	PINCONFIG(CONFIG_WCN14A2A_GPIO_MDM_SHLD_TRANS_ENA_NAME,
		  CONFIG_WCN14A2A_GPIO_MDM_SHLD_TRANS_ENA_PIN),
};

#define MDM_UART_DEV_NAME		CONFIG_WCN14A2A_UART_DRV_NAME
...
NET_DEVICE_OFFLOAD_INIT(modem_wcn14a2a, "MODEM_WCN14A2A",
			wcn14a2a_init, &ictx,
